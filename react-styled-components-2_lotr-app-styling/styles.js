...
// Definiere die Lora-Schriftart korrekt
const lora = Lora({
  subsets: ["latin"],
  style: ["normal", "italic"],
});

// GlobalStyle für die Anwendung mit korrekten Variablen
export const GlobalStyle = createGlobalStyle`
  ...
  *::after {
  ...
  body {
    font-family: var(--font-family); /* Setzt die Lora-Schriftart */
    background-color: var(--color-earth); /* Optional: dunkler Hintergrund */
    color: var(--color-clouds); /* Optional: helle Textfarbe */
    margin: 0;
    padding: 0;
    line-height: 1.5;
  }
